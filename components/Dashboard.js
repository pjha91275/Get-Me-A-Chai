                    ...
                    <div className={`${open ? 'block' : 'hidden'} mt-3 p-4 rounded`} style={{ backgroundColor: 'rgba(129,76,254,0.06)', border: '1px solid rgba(21,93,252,0.12)' }}>{
                        ...
                        <form className="max-w-2xl mx-auto" onSubmit={handleSubmit}>
                            ...
                            <div className="my-2">
                                ...
                                <input value={form.email ? form.email : ""} readOnly type="email" name='email' id="email" className=" block w-full p-2 text-xs text-gray-900 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 " />
                            </div>
                            {/* input forusername */}
                            <div className='my-2'>
