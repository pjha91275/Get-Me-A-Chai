  ...
  return (
    <div className="text-white py-14 container mx-auto">
      ...
      <div className="flex flex-col gap-3 min-h-screen items-center p-10">
        <button className="flex items-center w-64 bg-slate-50 text-black border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium transition-all duration-200 hover:bg-gray-200 hover:ring-4 hover:ring-indigo-500 hover:ring-offset-2 hover:ring-offset-white focus:ring-4 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-white focus:outline-none">
          <svg
        ...
        <button onClick={() => { signIn("github") }} className="flex items-center w-64 bg-slate-50 text-black border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium transition-all duration-200 hover:bg-gray-200 hover:ring-4 hover:ring-indigo-500 hover:ring-offset-2 hover:ring-offset-white focus:ring-4 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-white focus:outline-none">
          <svg
            className="h-6 w-6 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
