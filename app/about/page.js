...
const About = () => {
    return (
        <div className="container mx-auto px-8 md:px-4 py-8">
            <h1 className="text-3xl font-semibold mb-4 text-[#8A3DFC]">About Get Me a Chai</h1>
            ...
            <h2 className="text-2xl font-semibold mb-4 text-[#8A3DFC]">How It Works</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4" src="/group.gif" alt="Fans Want to Collaborate" />
                    <div>
                        <h3 className="text-xl font-semibold mb-2 text-[#397BFF]">Fans Want to Collaborate</h3>
                ...
                <div className="flex items-center mb-6">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-2 text-[#397BFF]">Support Through Chai</h3>
            ...
            <h2 className="text-2xl font-semibold mb-4 text-[#5F6CFF]">Benefits for Creators</h2>
            ...
            <div className="advantages mx-15 ">
            <h2 className="text-2xl font-semibold mb-4 text-[#5F6CFF]">Benefits for Fans</h2>
            <ul className="list-disc pl-6 mb-6">
            ...
            {/* Additional sections */}
            <div className="advantages">
            <h2 className="text-2xl font-semibold mb-4 text-[#5F6CFF]">Benefits of Collaboration</h2>
            <ul className="list-disc pl-6 mb-6">
...
<div className="advantages mx-15 ">
            <h2 className="text-2xl font-semibold mb-4 text-[#5F6CFF]">Community Engagement</h2>
            <ul className="list-disc pl-6 mb-6">
...
<div className="advantages">
            <h2 className="text-2xl font-semibold mb-4 text-[#5F6CFF]">Access to Resources</h2>
            <ul className="list-disc pl-6 mb-6">
...
<div className="advantages mx-15 ">
            <h2 className="text-2xl font-semibold mb-4 text-[#5F6CFF]">Recognition and Exposure</h2>
            <ul className="list-disc pl-6 mb-6">
...
<div className="advantages">
            <h2 className="text-2xl font-semibold mb-4 text-[#5F6CFF]">Supportive Community</h2>
            <ul className="list-disc pl-6 mb-6">
...
export const metadata = {
    ...
    description: "Learn more about Get Me a Chai, a crowdfunding platform for creators to get funded by their fans.",
  }
